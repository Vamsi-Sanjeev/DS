...
CREATE INDEX IF NOT EXISTS risk_data_timestamp_idx ON risk_data (timestamp);
CREATE INDEX IF NOT EXISTS risk_data_user_id_idx ON risk_data (user_id);
CREATE INDEX IF NOT EXISTS prediction_data_timestamp_idx ON prediction_data (timestamp);
CREATE INDEX IF NOT EXISTS prediction_data_user_id_idx ON prediction_data (user_id);